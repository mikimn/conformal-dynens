...
# # CIFAR10
# workdir="$(pwd)/.." # Note: Change work directory based on need
...
# CIFAR100
#workdir='/Users/yakiryehuda/Downloads/dynens' # Note: Change work directory based on need
...
datadir=('yahoo_answers_csv_imbalance3')
datafiles=('DS1' 'DS2' 'DS3')
